/*
Implement a function that computes the average degree of a graph, which is the average number of edges connected to the nodes in the graph.
*/
...
graph.print();
console.log(graph.degreeOfNode(graph, node));
console.log(graph.averageDegreeOfGraph(graph));
