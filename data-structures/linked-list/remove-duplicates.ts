...
export class CircularDoublyLinkedList<T> {
  ...
  removeDuplicates(): void {
    ...
    const hash: Map<T, T> = new Map();
    let currentNode = this.head;
    do {
      if (hash.has(currentNode.getValue())) {
      ...
      hash.set(currentNode.getValue(), currentNode.getValue());
...
console.log(circularDoublyLinkedList.removeDuplicates());
console.log(circularDoublyLinkedList.toString());
